...
BOT_TOKEN = environ.get('BOT_TOKEN', '8140217264:AAFmJI_xIJK-yFfHTnU8eXzozoW8UoI-V0k')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '@sunny55582636').split()]
USERNAME = environ.get('USERNAME', "https://t.me/sunny55582636") # ADMIN USERNAME
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', ' -1002376570586').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://gandudotcom9955:<db_8iZNxeXulrx9qly4>@cluster0.66uej.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'gandudotcom9955')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002376570586')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002460755631'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002460755631') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002460755631')) # 
...
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/tutorialshortlinks/7")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/tutorialshortlinks/7")
